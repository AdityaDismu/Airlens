...
export default function RouteExplorer() {
  ...
  return (
    <div className="page-shell route-explorer-page">
      <style>{`
        .route-explorer-page [class*="bg-[#FBF9F4]"] { background: #FFFFFF !important; }
        .route-explorer-page [class*="bg-[#F6F2EC]"],
        .route-explorer-page [class*="bg-[#F7F4EF]"],
        .route-explorer-page [class*="bg-[#F2EEE8]"] { background: #F1F4F6 !important; }
        .route-explorer-page [class*="border-[#DCD7CE]"],
        .route-explorer-page [class*="border-[#ECE8E1]"],
        .route-explorer-page [class*="border-[#E1DBD2]"] { border-color: #D9E1E7 !important; }
        .route-explorer-page [class*="text-[#30313A]"],
        .route-explorer-page [class*="text-[#3F3D45]"] { color: #17212B !important; }
        .route-explorer-page [class*="text-[#74727A]"],
        .route-explorer-page [class*="text-[#A19A9F]"],
        .route-explorer-page [class*="text-[#858087]"] { color: #667685 !important; }
        .route-explorer-page [class*="text-[#6B5A78]"],
        .route-explorer-page [class*="text-[#718A78]"] { color: #1976D2 !important; }
        .route-explorer-page .recharts-line-curve,
        .route-explorer-page .recharts-area-curve { stroke: #1976D2 !important; }
        .route-explorer-page .recharts-area-area { fill: #1976D2 !important; fill-opacity: .10 !important; }
        .route-explorer-page .recharts-cartesian-grid-horizontal line,
        .route-explorer-page .recharts-cartesian-grid-vertical line { stroke: #D9E1E7 !important; }
        .route-explorer-page .recharts-cartesian-axis-tick-value { fill: #667685 !important; }
        .route-explorer-page .recharts-reference-line-line { stroke: #38A9E8 !important; }
        .route-explorer-page .recharts-reference-line-label { fill: #38A9E8 !important; }
        .route-explorer-page [class*="bg-[#403946]"] { background: #FFFFFF !important; border: 1px solid #D9E1E7 !important; color: #17212B !important; }
        .route-explorer-page [class*="text-slate-400"] { color: #667685 !important; }
        .route-explorer-page [class*="text-blue-400"] { color: #1976D2 !important; }
        .route-explorer-page [class*="bg-[#F7F2E7]"] { background: #FFF8E8 !important; }
        .route-explorer-page [class*="bg-[#EEF5F0]"] { background: #EAF5EA !important; }
        .route-explorer-page [class*="bg-[#F7ECEA]"] { background: #FEF2F2 !important; }
        .route-explorer-page > .mb-7 > div > span { background: #EAF2F7 !important; border: 1px solid #D7E0E8 !important; color: #1976D2 !important; }
        .route-explorer-page > .mb-7 > div > span > span { background: #1976D2 !important; }
        .route-explorer-page .recharts-line-dot,
        .route-explorer-page .recharts-active-dot { fill: #1976D2 !important; stroke: #1976D2 !important; }
      `}</style>
      ...
      <Card className="mb-4 !px-5 !py-4">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
          <div className="w-full sm:max-w-[520px] sm:flex-1">
            ...
            <div className="mt-1 text-[11px] text-[#667685]">
              {coveredRouteCount} directional routes configured in the
              backend basket
            </div>
          </div>

          <div className="flex items-center justify-center py-1 text-[#1976D2] sm:pb-2">
            →
          </div>

          <div className="text-left text-xs text-[#667685] sm:ml-auto sm:min-w-[170px] sm:text-right">
            <div>Route source</div>

            <b className="text-[#17212B]">
      ...
      {loading ? (
        <div className="py-16 text-center text-sm text-[#667685]">
          Loading route data…
        </div>
      ) : (
        <>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
            <Card>
              ...
              <div className="mt-1 text-xs text-[#667685]">
                Latest route snapshot
              </div>

              <div className="mt-5 space-y-2 text-xs">
                <div className="flex justify-between">
                  <span className="text-[#667685]">Change</span>
                ...
                <div className="flex justify-between">
                  <span className="text-[#667685]">Coverage</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
            ...
            <Card>
              ...
              {elasticity?.status === 'success' ? (
                ...
                <div className="mt-6 text-sm text-[#667685]">
          ...
          <Card padding="none">
            <div className="px-5 py-4 border-b border-[#D9E1E7]">
                ...
                <tbody>
                  {filtered.map((o) => (
                    ...
                    >
                      ...
                      <td className="font-mono text-[#667685]">
                        {o.flight_number || '—'}
                      </td>
                      ...
                      <td className="font-mono text-[#1976D2]">
                        T+{o.advance_days}
                      </td>
            ...
            <div className="px-5 py-3 border-t border-[#D9E1E7] flex items-center justify-between text-xs text-[#667685]">
              <span>
