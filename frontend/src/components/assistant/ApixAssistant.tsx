...
export default function ApixAssistant() {
  ...
  if (!open) {
    return (
      ...
      >
        <MessageCircle size={22} className="text-white stroke-white" />
        <span className="absolute -right-1 -top-1 flex h-5 w-5 items-center justify-center rounded-full bg-[#38A9E8] text-[9px] font-bold text-[#16202B]">AI</span>
      </button>
    );
  }
  ...
  return (
    <section aria-label="APIx Assistant" className="fixed bottom-5 right-5 z-50 flex w-[min(390px,calc(100vw-24px))] flex-col overflow-hidden rounded-3xl border border-[#D9E1E7] bg-white shadow-[0_20px_60px_rgba(70,61,69,0.16)]">
      ...
      <div className="border-t border-[#D9E1E7] bg-white p-3">
        ...
        <div className="mt-2 flex items-center justify-between text-[9px] text-[#9A9499]">
